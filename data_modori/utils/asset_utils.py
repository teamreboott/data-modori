...
ASSET_LINKS = {
    ...
    'data_modori/flagged_words.json',
    'stopwords':
    'https://dail-wlcb.oss-cn-wulanchabu.aliyuncs.com/'
    'data_modori/stopwords.json',
}
...
def load_words_asset(words_dir: str, words_type: str):
    ...
    file, then download it from ASSET_LINKS cached by data_modori team.
    ...
    if not bool(words_dict):
        logger.info(f'Specified {words_dir} does not contain '
                    ...
                    'download the one cached by data_modori team')
